...
},{"./factoryWithThrowingShims":"wVGV"}],"X+d2":[function(require,module,exports) {
"use strict";
...
var Poly = function Poly(props) {
  var points = [];

  for (var i = 1; i < props.sides + 2; i++) {
    var cx = props.cx || props.r;
    var cy = props.cy || props.r;
    points.push({
  ...
  points.forEach(function (val) {
    pointsStr += "".concat(val.x, ",").concat(val.y, " ");
  });
  return _react.default.createElement("svg", {
    width: props.width || props.r * 2,
    height: props.width || props.r * 2
...
},{"react":"1n8/","prop-types":"5D9O"}]},{},["X+d2"], null)
//# sourceMappingURL=/Poly.map